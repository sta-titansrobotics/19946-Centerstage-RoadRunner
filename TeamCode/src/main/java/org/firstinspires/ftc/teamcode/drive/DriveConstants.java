...
public class DriveConstants {
     ...
     * inches.
     */
    public static double MAX_VEL = 3.5044287;
    public static double MAX_ACCEL = 3.5044287;
    public static double MAX_ANG_VEL = Math.toRadians(180); //might just leave this as default value
